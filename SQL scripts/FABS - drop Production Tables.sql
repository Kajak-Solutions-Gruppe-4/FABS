...
GO
/****** Object:  Table [dbo].[zipcode_country_city]    Script Date: 01/11/2021 10.55.31 ******/
...
GO
/****** Object:  Table [dbo].[associations]    Script Date: 01/11/2021 10.55.32 ******/
...
GO
/****** Object:  Table [dbo].[association_warehouse]    Script Date: 01/11/2021 10.55.32 ******/
...
GO
/****** Object:  Table [dbo].[association_person]    Script Date: 01/11/2021 10.55.32 ******/
...
GO
/****** Object:  Table [dbo].[addresses]    Script Date: 01/11/2021 10.55.32 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[addresses]') AND type in (N'U'))
DROP TABLE [dbo].[addresses]
GO
-- Outcommented because production server does not allow Drop DB
--USE [master]
--GO
--/****** Object:  Database [FABS]    Script Date: 01/11/2021 10.55.32 ******/
--DROP DATABASE [FABS]
--GO
